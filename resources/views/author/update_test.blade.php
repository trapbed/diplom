...
@section('title', "Редактирование теста '{{ $data->title }}'")
@section('content')
    ...
    <span class="ff_mr fsz_1_5 c_dp">Редактирование теста "{{ $data->title }}"</span>
    ...
    <div id="preview"  class="sc_w_th oy_s h27 df fdr_c g1 pos_r">
        ...
        <form method="POST" action="{{ route('create_test_db') }}" id="preview_inputs">
            ...
            {{--@if (!old('old_html'))--}}
                ...
                <form method="POST" action="" id="preview_inputs">
                    @csrf          
                    <input type="hidden" name="timer" id="preview_timer_minutes" value="{{ $data->timer }}">
                    <label class="fsz_1_2 ff_mr c_dp df fdr_c g0_5" for="title">Заголовок тестирования
                        <input required="" id="title_lesson" class="w48 h1 paa_0_3 ff_mr fsz_1 br_03 brc_lp ou_n" type="text" name="title_test" value="{{old('title_test') ? old('title_test') : $data->title }}">
                    </label>
                
                    @foreach (json_decode($data->content, TRUE) as $key=>$val)
                        @if ($key == 'content')
                            @foreach ($val as $key2=>$val2)
                                @switch(key($val2))
                                    @case('one_answer')
                                        <label for="one_answer_{{ $key2 }}" id="one_answer_{{ $key2 }}_hidden">
                                            <input type="hidden" name="one_answer[{{ $key2 }}][question]" id="one_answer_{{ $key2 }}_question" value="{{$val2['one_answer']['question']}}">
                                            <select id="one_answer_{{ $key2 }}_answers" multiple="multiple" hidden="" name="one_answer[{{ $key2 }}][answers][]">
                                                @foreach($val2['one_answer']['answers'] as $answer_id=>$answer_val)
                                                    <option selected="true" value="Луна" id="input_various_{{ $key2 }}_{{ $answer_id }}">{{ $answer_val }}</option>
                                                @endforeach
                                            </select>
                                            <input type="hidden" id="one_answer_{{ $key2 }}_current" name="one_answer[{{ $key2 }}][current]" value="{{ $val2['one_answer']['current'] }}">
                                        </label>
                                        @break
                                    @case('word')
                                        @break
                    ...
                    <label for="subsequence_2" id="subsequence_2_hidden">
                        <input type="hidden" id="subsequence_2_question_hidden" name="subsequence[2][question]" value="Расставьте планеты в правильном порядке">
                        <select multiple="multiple" hidden="" name="subsequence[2][answers][]">
                            
                        <option value="Меркурий" selected="true" id="subsequence_2_2">Меркурий</option><option value="Венера" selected="true" id="subsequence_2_3">Венера</option><option value="Юпитер" selected="true" id="subsequence_2_3">Юпитер</option></select>
                    </label><label for="word_3" id="word_3_hidden">
                        <input type="hidden" name="word[3][question]" id="word_3_question_hidden" value="Самая большая звезда">
                        <input type="hidden" name="word[3][current]" id="word_3_answer_hidden" value="Солнце">
                    </label><label for="some_answer_4_question" id="some_answer_4_question">
                        <input type="hidden" name="some_answer[4][question]" value="Выберите созвездия" id="some_answer_4_question_hidden">
                    </label><label for="some_answer_4_incorrect" id="some_answer_4_incorrect">
                        <input type="hidden" name="some_answer[4][incorrect][1]" id="some_answer_4_1_incorrect" value="Ответ 1">
                    <input hidden="true" name="some_answer[4][incorrect][2]" id="some_answer_4_2_incorrect" value="Млечный путь "><input hidden="true" name="some_answer[4][incorrect][3]" id="some_answer_4_3_incorrect" value="Центавр "><input hidden="true" name="some_answer[4][incorrect][4]" id="some_answer_4_4_incorrect" value="Скорпион"></label><label for="some_answer_4_correct" id="some_answer_4_correct"></label></form>
                ...
                @foreach ($val as $key2=>$val2)
                    @switch(key($val2))
                        @case('one_answer')
                            ...
                            <div class="test_task df fdr_c g1" id="one_answer_{{ $key2 }}">
                            <p class="ff_m fsz_1 c_dp">Задание {{ $key2 }} - с одним вариантом ответа</p>
                            <div class="df fdr_c g0_5">
                                <span class="fsz_0_8 ff_m">&nbsp; Текст вопроса</span>
                                <input type="hidden" value="one_answer_text" name="type_{{ $key2 }}">
                                
                                <input onchange="one_answer_change_question({{ $key2 }})" onkeyup="one_answer_change_question({{ $key2 }})" onkeydown="one_answer_change_question({{ $key2 }})" onkeypress="one_answer_change_question({{ $key2 }})" oninput="one_answer_change_question({{ $key2 }})" onpaste="one_answer_change_question({{ $key2 }})" class="ff_ml fsz_0_8 ou_n paa_0_3 brc_lp wmx_46 br_03" type="text" value="{{$val2['one_answer']['question']}}" id="one_answer_question_{{ $key2 }}" name="text_{{ $key2 }}">
                            </div>

                        <div class="df fdr_c g0_5">
                            <span class="ff_m fsz_0_8">&nbsp; Варианты ответа</span>
                            <div class="df fdr_r g1">
                                <input class="ou_n br_03 brc_lp paa_0_3 ff_ml fsz_0_8 w16" type="text" name="various_1" id="various_1">
                                <input class="ou_n btn_dp_lp ff_m fsz_0_8 paa_0_3 br_03" type="submit" value="+" onclick="one_answer(event, &#39;various_1&#39;, 1)">
                            </div>
                            <span class="attention_task" id="attention_task_1"></span>
                            <table id="all_various_1" class="w40 border_various">
                                <tbody>
                            <tr class="border_various count_td_task_1" id="one_answer_various_td_4_2">
                        <td class="ff_m fsz_0_8 w40 df fdr_r jc_spb "><div><input class="one_answer_answers_4" id="get_value_one_answer_4_2" type="radio" name="input_various_4" value="Луна" onclick="one_answer_change_inputs(event, &#39;4&#39;, &#39;2&#39;)" checked="checked">Луна</div> <div class="w1_5 h1_5 paa_0_3 btn_dp_lp fsz_0_8 df ali_c jc_c br_03" onclick="del_one_answer_various(4, 2,&#39;one_answer_various_td_4_2&#39;, event)">x</div></td>
                </tr><tr class="border_various count_td_task_1" id="one_answer_various_td_4_3">
                        <td class="ff_m fsz_0_8 w40 df fdr_r jc_spb "><div><input class="one_answer_answers_4" id="get_value_one_answer_4_3" type="radio" name="input_various_4" value=" Марс" onclick="one_answer_change_inputs(event, &#39;4&#39;, &#39;3&#39;)"> Марс</div> <div class="w1_5 h1_5 paa_0_3 btn_dp_lp fsz_0_8 df ali_c jc_c br_03" onclick="del_one_answer_various(4, 3,&#39;one_answer_various_td_4_3&#39;, event)">x</div></td>
                </tr><tr class="border_various count_td_task_1" id="one_answer_various_td_4_4">
                        <td class="ff_m fsz_0_8 w40 df fdr_r jc_spb "><div><input class="one_answer_answers_4" id="get_value_one_answer_4_4" type="radio" name="input_various_4" value="Венера" onclick="one_answer_change_inputs(event, &#39;4&#39;, &#39;4&#39;)">Венера</div> <div class="w1_5 h1_5 paa_0_3 btn_dp_lp fsz_0_8 df ali_c jc_c br_03" onclick="del_one_answer_various(4, 4,&#39;one_answer_various_td_4_4&#39;, event)">x</div></td>
                </tr></tbody></table>
                            <span class="ff_ml fsz_0_8">(отметьте правильный ответ)</span>
                        </div>
                        <div class="del_test_task" onclick="del_test_task(&#39;one_answer_1&#39;)">x</div></div>
        ...
        <div class="test_task df fdr_c g1" id="one_answer_1">
                        <p class="ff_m fsz_1 c_dp">Задание 1 - с одним вариантом ответа</p>
                        <!-- Задание с одним верным вариантом -->
                        <div class="df fdr_c g0_5">
                            <span class="fsz_0_8 ff_m">&nbsp; Текст вопроса</span>
                            <input type="hidden" value="one_answer_text" name="type_1">
                            
                            <input onchange="one_answer_change_question(1)" onkeyup="one_answer_change_question(1)" onkeydown="one_answer_change_question(1)" onkeypress="one_answer_change_question(1)" oninput="one_answer_change_question(1)" onpaste="one_answer_change_question(1)" class="ff_ml fsz_0_8 ou_n paa_0_3 brc_lp wmx_46 br_03" type="text" value="Спутник планеты Земля" id="one_answer_question_1" name="text_1">
                        </div>
                        ...
                        <div class="del_test_task" onclick="del_test_task(&#39;one_answer_1&#39;)">x</div></div><div class="test_task" id="subsequence_2">
                    <p class="ff_m fsz_1 c_dp">Задание 2 - последовательность</p>
                    
                    <div class="df fdr_c g0_5">
                        <span class="ff_m fsz_0_8">&nbsp; Текст вопроса</span>
                        
                        <input onchange="subsequence_change_question(2)" onkeyup="subsequence_change_question(2)" onkeydown="subsequence_change_question(2)" onkeypress="subsequence_change_question(2)" oninput="subsequence_change_question(2)" onpaste="subsequence_change_question(2)" class="ff_ml fsz_0_8 ou_n paa_0_3 brc_lp wmx_46 br_03" type="text" id="subsequence_2_question_viewed" name="subsequence[2][question]" value="Расставьте планеты в правильном порядке">
                    ...
                    <div class="df fdr_c g0_5">
                        ...
                        <div class="df fdr_r g1">
                            <input class="ou_n br_03 brc_lp paa_0_3 ff_ml fsz_0_8 w16" type="text" name="various_2" id="various_2">
                            <input class="ou_n btn_dp_lp ff_m fsz_0_8 paa_0_3 br_03 h2 w2" type="submit" value="+" onclick="add_subsequence(event, &#39;various_2&#39;, &#39;list_various_2&#39;)" form="middle">
                        </div>
                        <span class="ff_ml fsz_0_8">(поставьте в правильном порядке)</span>
                        <div class="df fdr_c g1 points_list" id="list_various_2">
                                                        
                        <div class="one_point" id="list_point_2_2" draggable="true" ondragstart="dragStart(event)" ondragover="dragOver(event)" ondrop="drop(event)" ondragend="dragEnd(event)">
                        <span class="fsz_0_8 ff_m w40 ">Меркурий</span>
                        <div class="df fdr_c jc_spb h3">
                            <span class="fsz_1_5 lh_1_5">⥎</span>
                            <span class="fsz_1_5 lh_1_5">⥐</span>
                        </div>
                        <div onclick="del_subsequence(&#39;list_point_2_2&#39;, 2, 2)" class="fsz_1 ff_ml btn_dp_lp paa_0_3 df fdr_c ali_c jc_c br_03">
                            x
                        </div></div><div class="one_point" id="list_point_2_3" draggable="true" ondragstart="dragStart(event)" ondragover="dragOver(event)" ondrop="drop(event)" ondragend="dragEnd(event)">
                        <span class="fsz_0_8 ff_m w40 ">Венера</span>
                        <div class="df fdr_c jc_spb h3">
                            <span class="fsz_1_5 lh_1_5">⥎</span>
                            <span class="fsz_1_5 lh_1_5">⥐</span>
                        </div>
                        <div onclick="del_subsequence(&#39;list_point_2_3&#39;, 2, 3)" class="fsz_1 ff_ml btn_dp_lp paa_0_3 df fdr_c ali_c jc_c br_03">
                            x
                        </div></div><div class="one_point" id="list_point_2_3" draggable="true" ondragstart="dragStart(event)" ondragover="dragOver(event)" ondrop="drop(event)" ondragend="dragEnd(event)">
                        <span class="fsz_0_8 ff_m w40 ">Юпитер</span>
                        <div class="df fdr_c jc_spb h3">
                            <span class="fsz_1_5 lh_1_5">⥎</span>
                            <span class="fsz_1_5 lh_1_5">⥐</span>
                        </div>
                    ...
                    <div class="del_test_task" onclick="del_test_task(&#39;subsequence_2&#39;)">x</div>
                    </div><div class="test_task" id="word_3">
                    <p class="ff_m fsz_1 c_dp">Задание 3 - текстовый ответ</p>
                    <!-- Задание с одним верным вариантом -->
                    <div class="df fdr_c g0_5">
                        <span class="ff_m fsz_0_8">&nbsp; Текст вопроса</span>
                        <input type="hidden" value="word" name="type_3">
                        <input onchange="word_change_question(3)" onkeyup="word_change_question(3)" onkeydown="word_change_question(3)" onkeypress="word_change_question(3)" oninput="word_change_question(3)" onpaste="word_change_question(3)" class="ff_ml fsz_0_8 ou_n paa_0_3 brc_lp wmx_46 br_03" type="text" id="word_3_question_viewed" name="word_3_question" value="Самая большая звезда">

                    </div>

                    <div class="df fdr_c g0_5">
                        <span class="ff_m fsz_0_8">&nbsp; Ответ</span>
                        <input onchange="word_change_answer(3)" onkeyup="word_change_answer(3)" onkeydown="word_change_answer(3)" onkeypress="word_change_answer(3)" oninput="word_change_answer(3)" onpaste="word_change_answer(3)" class="ff_m fsz_0_8 c_dp brc_lp br_03 paa_0_3 ou_n w46" type="text" id="word_answer_3" name="word_answer3" value="Солнце">
                       
                    </div>
                    <div class="del_test_task" onclick="del_test_task(&#39;word_3&#39;)">x</div>
                    </div><div class="test_task" id="some_answer_4">
                    <p class="ff_m fsz_1 c_dp">Задание 4 - несколько правильных ответов</p>
                    <div class="df fdr_c g0_5 fsz_0_8">
                        <span class="fsz_0_8">&nbsp; Текст вопроса</span>
                        <input type="hidden" value="one_answer" name="type_1">
                        <input onchange="some_answer_change_question(4)" onkeyup="some_answer_change_question(4)" onkeydown="some_answer_change_question(4)" onkeypress="some_answer_change_question(4)" oninput="some_answer_change_question(4)" onpaste="some_answer_change_question(4)" class="ff_ml fsz_0_8 h1_5 ou_n paa_0_3 brc_lp wmx_46 br_03" type="text" id="some_answer_4_question_viewed" name="text_1" value="">
                    ...
                    <div class="df fdr_c g0_5 fsz_0_8">
                        &nbsp; Варианты ответа
                        <div class="df fdr_r g1">
                            <input required="" class="h1_5 ou_n br_03 brc_lp paa_0_3 ff_ml fsz_0_8 w16" type="text" name="various_4" id="various_4">
                            <input class="ou_n btn_dp_lp ff_m fsz_0_8 br_03 h2 w2" type="submit" value="+" onclick="add_some_answer(event, &#39;various_4&#39;, 4)" form="middle">
                        </div>
                        <!-- <span class="ff_ml fsz_0_8">(поставьте в правильном порядке)</span> -->
                        <div class="df fdr_c g1 points_list" id="list_various_4">
                            <div class="one_point_5" id="list_point_4_1">
                                <div class="df fdr_r g2">
                                    <input type="checkbox" class="some_answer_answers_4" name="" id="some_answer_answers_4_1" value="" onclick="some_answer_to_correct(4, 1, &#39;Ответ 1&#39;)"> 
                                    <span class="fsz_0_8 ff_m">Ответ 1</span>
                                </div>
                                
                                <div class="btn_dp_lp paa_0_5 br_03">x</div>
                            </div>                            
                        <div class="one_point_5" id="list_point_4_2"><div class="df fdr_r g2">
                                        <input type="checkbox" class="some_answer_answers_4" name="" id="some_answer_answers_4_2" value="" onclick="some_answer_to_correct(4, 2, &#39;Млечный путь &#39;)"> 
                                        <span class="fsz_0_8 ff_m">Млечный путь </span>
                                    </div>
                                    
                                    <div class="btn_dp_lp paa_0_5 br_03">x</div></div><div class="one_point_5" id="list_point_4_3"><div class="df fdr_r g2">
                                        <input type="checkbox" class="some_answer_answers_4" name="" id="some_answer_answers_4_3" value="" onclick="some_answer_to_correct(4, 3, &#39;Центавр &#39;)"> 
                                        <span class="fsz_0_8 ff_m">Центавр </span>
                                    </div>
                                    
                                    <div class="btn_dp_lp paa_0_5 br_03">x</div></div><div class="one_point_5" id="list_point_4_4"><div class="df fdr_r g2">
                                        <input type="checkbox" class="some_answer_answers_4" name="" id="some_answer_answers_4_4" value="" onclick="some_answer_to_correct(4, 4, &#39;Скорпион&#39;)"> 
                                        <span class="fsz_0_8 ff_m">Скорпион</span>
                                    </div>
                                    
                                    <div class="btn_dp_lp paa_0_5 br_03">x</div></div></div>
                    </div>
                    <div class="del_test_task" onclick="del_test_task(&#39;some_answer_4&#39;)">x</div>
                    </div></div>
